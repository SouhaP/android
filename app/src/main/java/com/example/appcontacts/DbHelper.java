    ...
    public ArrayList<ModelContact> getSearchContact(String query){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                group.setId(cursor.getString(cursor.getColumnIndexOrThrow(Constants.C_GROUP_ID))); // Assuming the column name for group ID is C_GROUP_ID in Constants
                    group.setName(cursor.getString(cursor.getColumnIndexOrThrow(Constants.C_NAME))); // Assuming the column name for group name is C_GROUP_NAME in Constants
